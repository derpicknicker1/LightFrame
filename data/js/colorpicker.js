            ...
            init: function(opt) {
                ...
                return this.each(function() {
                    if (!$(this).data('colorpickerId')) {
                        ...
                        cal.find('>div.colorpicker_current_color').bind('click', restoreOriginal);
...
(function($){var EYE=window.EYE=function(){var a = {init: []};return{init:function(){$.each(a.init,function(nr,d){d.call();});},extend:function(b){for(var i in b){if(b[i]!=undefined){this[i]=b[i];}}},register:function(d,c){if(!a[c]){a[c]=[];}a[c].push(d);}};}();$(EYE.init);})(jQuery);
(function($){})(jQuery);
